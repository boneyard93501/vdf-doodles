...
fn main() {
    ...
    let data_size = 1024; // * 1024 * 1024 * * 1024 * 16 // 16 GB
    ...
    let difficulty = 10000; // 1_000_000;
    ...
    println!("time to verify: {} seconds", verifier_duration.as_secs());
